...
<div class="td-admin-wrap about-wrap td-wp-admin-welcome">
    ...
    <div class="td-welcome-sidebar">
        <div class="td-welcome-widget td-widget-system-status">
            ...
            <!-- PHP Memory Limit -->
            <div class="td-wp-admin-status">
                <span class="td-system-desc">PHP Memory Limit</span>
                <?php if ($memory_limit_bytes > 134217728) { ?>
                    <span class="td-system-green td-system-svg-icon"></span>
                    <span class="td-system-value"><?php echo esc_html($memory_limit); ?><br></span>
                <?php } else { ?>
                    <span class="td-system-yellow td-system-svg-icon"></span>
                    <span class="td-system-value"><?php echo esc_html($memory_limit); ?><br></span>
                    <span class="td-system-error">&rBarr; We recommend memory to at least <b>128 MB</b>. <a target="_blank" href="https://wordpress.org/support/article/editing-wp-config-php/#increasing-memory-allocated-to-php">Read more</a></span>
                <?php } ?>
            </div>
            <!-- PHP Execution Time -->
            <div class="td-wp-admin-status">
